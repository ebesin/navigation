...
public:
    ...
    void   filtVector(const std::vector<double>& t, std::vector<double>& u, bool init_first_value = true);
    void   filtFiltVector(const std::vector<double>& t, std::vector<double>& u, bool init_first_value = true);
...
private:
    ...
    // polynomial
    std::vector<std::complex<double>> polynomialFromRoots(std::vector<std::complex<double>>& roots);
