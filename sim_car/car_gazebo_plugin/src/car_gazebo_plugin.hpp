...
public:
    BicycleModel(double wheelbase_length,
                 double steer_angle     = 0.0,
                 double max_steer_angle = M_PI / 4.0)
    {
    ...
    double get_rear_curvature() { return tan(this->steer_angle) / this->wheelbase_length; }
    ...
    double get_front_curvature() { return sin(this->steer_angle) / this->wheelbase_length; }
...
private:
    ...
    gazebo::common::PID fl_pid, fr_pid, bl_pid, br_pid, fl_shock_pid, fr_shock_pid, bl_shock_pid,
        br_shock_pid;
    ...
    void twist_callback(geometry_msgs::msg::Twist::SharedPtr msg)
    {
        ...
        if (msg->linear.x == 0) {
            ...
            // ad.drive.steering_angle = msg->angular.z;
        }
        // ad.drive.steering_angle = msg->angular.z;
        // ad.drive.speed          = msg->linear.x;
        ackermann_pub->publish(ad);
