...
nav2_util::CallbackReturn InitPoseSubscriber2D::on_configure(const rclcpp_lifecycle::State& state)
{
...
nav2_util::CallbackReturn InitPoseSubscriber2D::on_activate(const rclcpp_lifecycle::State& state)
{
...
nav2_util::CallbackReturn InitPoseSubscriber2D::on_deactivate(const rclcpp_lifecycle::State& state)
{
...
nav2_util::CallbackReturn InitPoseSubscriber2D::on_cleanup(const rclcpp_lifecycle::State& state)
{
...
nav2_util::CallbackReturn InitPoseSubscriber2D::on_shutdown(const rclcpp_lifecycle::State& state)
{
