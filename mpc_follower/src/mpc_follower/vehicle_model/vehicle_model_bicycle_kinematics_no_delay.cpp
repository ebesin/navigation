...
void KinematicsBicycleModelNoDelay::calculateDiscreteMatrix(
    Eigen::MatrixXd& a_d, Eigen::MatrixXd& b_d, Eigen::MatrixXd& c_d,
    Eigen::MatrixXd& w_d, const double dt) {
  ...
  // std::cout << w_d << std::endl;
  // std::cout << "m_velocity:" << m_velocity << "  m_wheelbase:" << m_wheelbase
  // << "  delta_r:" << delta_r << std::endl; bilinear discretization for ZOH
  // system no discretization is needed for Cd
...
void KinematicsBicycleModelNoDelay::calculateReferenceInput(
