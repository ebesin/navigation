...
protected:
   ...
   */
    void enforceStartBoundaryConditions(const geometry_msgs::msg::Pose&   start_pose,
   ...
   */
    template<typename IteratorT> BoundaryExpansions generateBoundaryExpansionPoints(IteratorT start, IteratorT end);
