 ...
 * @Description  : vehicle model class of bicycle kinematics without steering
 * delay
 *
 ...
 * dx2/dt = v * tan(u) / W
 *
 *    Linearized model around reference point (v = v_r, th = th_r, steer =
 * steer_r) dx/dt = [0, vr] * x + [                  0] * u + [ 0] [0,  0]
 * [vr/W/cos(steer_r)^2]       [-vr*steer_r/W/cos(steer_r)^2]
 *
 */
...
class KinematicsBicycleModelNoDelay : public VehicleModelInterface {
 public:
   ...
   */
  void calculateDiscreteMatrix(Eigen::MatrixXd& a_d, Eigen::MatrixXd& b_d,
                               Eigen::MatrixXd& c_d, Eigen::MatrixXd& w_d,
