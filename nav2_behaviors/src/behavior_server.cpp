...
nav2_util::CallbackReturn BehaviorServer::on_configure(
    ...
    for (size_t i = 0; i != behavior_ids_.size(); i++) {
        ...
        try {
            ...
            behaviors_.back()->configure(
                node, behavior_ids_[i], tf_, collision_checker_);
        }
...
nav2_util::CallbackReturn BehaviorServer::on_activate(
    const rclcpp_lifecycle::State& /*state*/)
{
...
nav2_util::CallbackReturn BehaviorServer::on_deactivate(
    const rclcpp_lifecycle::State& /*state*/)
{
...
nav2_util::CallbackReturn BehaviorServer::on_cleanup(
    const rclcpp_lifecycle::State& /*state*/)
{
...
nav2_util::CallbackReturn BehaviorServer::on_shutdown(
