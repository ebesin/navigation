...
inline visualization_msgs::msg::Marker createDefaultMarker(const std::string&                 frame_id,
...
inline visualization_msgs::msg::Marker createDeletedDefaultMarker(const rclcpp::Time& now,
                                                                  const std::string&  ns,
                                                                  const int32_t       id)
{
    visualization_msgs::msg::Marker marker;
...
inline void appendMarkerArray(const visualization_msgs::msg::MarkerArray& additional_marker_array,
