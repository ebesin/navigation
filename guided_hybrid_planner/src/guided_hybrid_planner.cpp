                                    ...
                                    std::shared_ptr<nav2_costmap_2d::Costmap2DROS>  costmap_ros)
{
    ...
    nav2_util::declare_parameter_if_not_declared(
        node, name + ".max_steer_angle", rclcpp::ParameterValue(27.0));
    node->get_parameter(name + ".max_steer_angle", serch_info_.max_steer_angle);

    nav2_util::declare_parameter_if_not_declared(
        node, name + ".wheel_base", rclcpp::ParameterValue(0.65));
    ...
    nav2_util::declare_parameter_if_not_declared(
        node, name + ".travel_unknown", rclcpp::ParameterValue(false));
    node->get_parameter(name + ".travel_unknown", serch_info_.travel_unknown);

    nav2_util::declare_parameter_if_not_declared(
        node, name + ".shot_distance", rclcpp::ParameterValue(3.0));
    ...
    nav2_util::declare_parameter_if_not_declared(
        node, name + ".steering_penalty", rclcpp::ParameterValue(1.05));
