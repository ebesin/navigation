                         ...
                         const std::vector<double>& query_keys)
{
    ...
    for (const auto query_key : validated_query_keys) {
        ...
        const double ratio   = (query_key - base_keys.at(key_index)) / (base_keys.at(key_index + 1) - base_keys.at(key_index));
...
double lerp(const std::vector<double>& base_keys, const std::vector<double>& base_values, double query_key)
{
