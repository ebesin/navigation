...
typedef std::vector<geometry_msgs::msg::PoseStamped>::reverse_iterator
    ReversePathIterator;
...
protected:
   ...
   * @return If smoothing was successful
   */
    bool smoothImpl(nav_msgs::msg::Path&              path,
   ...
   * @return dim value
   */
    inline double getFieldByDim(const geometry_msgs::msg::PoseStamped& msg,
   ...
   */
    inline void setFieldByDim(geometry_msgs::msg::PoseStamped& msg,
                              const unsigned int               dim,
                              const double&                    value);
   ...
   */
    std::vector<PathSegment> findDirectionalPathSegments(
   ...
   * @param reversing_segment Whether this path segment is in reverse
   */
    void enforceEndBoundaryConditions(const geometry_msgs::msg::Pose& end_pose,
                                      nav_msgs::msg::Path&            path,
                                      const nav2_costmap_2d::Costmap2D* costmap,
                                      const bool& reversing_segment);
   ...
   * @param reversing_segment Whether this path segment is in reverse
   */
    void findBoundaryExpansion(const geometry_msgs::msg::Pose&   start,
   ...
   */
    ...
    BoundaryExpansions generateBoundaryExpansionPoints(IteratorT start,
                                                       IteratorT end);
