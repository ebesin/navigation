...
public:
    ...
    geometry_msgs::msg::TransformStamped::ConstSharedPtr getLatestTransform(const std::string& from, const std::string& to)
    {
        ...
        try {
            ...
            RCLCPP_WARN(logger_, "failed to get transform from %s to %s: %s", from.c_str(), to.c_str(), ex.what());
            return {};
        }
    ...
    geometry_msgs::msg::TransformStamped::ConstSharedPtr getTransform(const std::string&      from,
                                                                      const std::string&      to,
