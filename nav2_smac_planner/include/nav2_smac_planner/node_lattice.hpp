...
struct LatticeMotionTable
{
   ...
   */
    static LatticeMetadata getLatticeMetadata(
...
public:
   ...
   */
    static void resetObstacleHeuristic(nav2_costmap_2d::Costmap2D* costmap,
                                       ...
                                       const unsigned int&         goal_y)
    {
        ...
        NodeHybrid::resetObstacleHeuristic(
            costmap, start_x, start_y, goal_x, goal_y);
    }
   ...
   */
    static float getObstacleHeuristic(const Coordinates& node_coords,
                                      const Coordinates& goal_coords,
                                      const double&      cost_penalty)
    {
        return NodeHybrid::getObstacleHeuristic(
            node_coords, goal_coords, cost_penalty);
    }
   ...
   * @return heuristic Heuristic value
   */
    static float getDistanceHeuristic(const Coordinates& node_coords,
                                      const Coordinates& goal_coords,
