 ...
 */
#ifndef MPC_UTILS__GEOMETRY__GEOMETRY_HPP_
#define MPC_UTILS__GEOMETRY__GEOMETRY_HPP_
...
template<>
inline void doTransform(const geometry_msgs::msg::Point&            t_in,
...
template<>
inline void doTransform(const geometry_msgs::msg::Pose&             t_in,
...
namespace mpc_utils {
template<class T> geometry_msgs::msg::Point getPoint(const T& p)
{
    return geometry_msgs::build<geometry_msgs::msg::Point>().x(p.x).y(p.y).z(p.z);
}

template<> inline geometry_msgs::msg::Point getPoint(const geometry_msgs::msg::Point& p)
{
    return p;
}

template<> inline geometry_msgs::msg::Point getPoint(const geometry_msgs::msg::Pose& p)
{
    return p.position;
}

template<> inline geometry_msgs::msg::Point getPoint(const geometry_msgs::msg::PoseStamped& p)
{
    return p.pose.position;
}

template<> inline geometry_msgs::msg::Point getPoint(const geometry_msgs::msg::PoseWithCovarianceStamped& p)
{
    return p.pose.pose.position;
}

template<> inline geometry_msgs::msg::Point getPoint(const mpc_msgs::msg::PathPoint& p)
{
    return p.pose.position;
}

template<> inline geometry_msgs::msg::Point getPoint(const mpc_msgs::msg::TrajectoryPoint& p)
{
    return p.pose.position;
}

template<class T> geometry_msgs::msg::Pose getPose([[maybe_unused]] const T& p)
{
...
template<> inline geometry_msgs::msg::Pose getPose(const geometry_msgs::msg::Pose& p)
{
    return p;
}

template<> inline geometry_msgs::msg::Pose getPose(const geometry_msgs::msg::PoseStamped& p)
{
    return p.pose;
}

template<> inline geometry_msgs::msg::Pose getPose(const mpc_msgs::msg::PathPoint& p)
{
    return p.pose;
}

template<> inline geometry_msgs::msg::Pose getPose(const mpc_msgs::msg::TrajectoryPoint& p)
{
    return p.pose;
}

template<class T> double getLongitudinalVelocity([[maybe_unused]] const T& p)
{
...
template<> inline double getLongitudinalVelocity(const mpc_msgs::msg::PathPoint& p)
{
    return p.longitudinal_velocity_mps;
}

template<> inline double getLongitudinalVelocity(const mpc_msgs::msg::TrajectoryPoint& p)
{
    return p.longitudinal_velocity_mps;
}

template<class T> void setPose([[maybe_unused]] const geometry_msgs::msg::Pose& pose, [[maybe_unused]] T& p)
{
    static_assert(sizeof(T) == 0, "Only specializations of getPose can be used.");
    throw std::logic_error("Only specializations of getPose can be used.");
}

template<> inline void setPose(const geometry_msgs::msg::Pose& pose, geometry_msgs::msg::Pose& p)
{
    p = pose;
}

template<> inline void setPose(const geometry_msgs::msg::Pose& pose, geometry_msgs::msg::PoseStamped& p)
{
    p.pose = pose;
}

template<> inline void setPose(const geometry_msgs::msg::Pose& pose, mpc_msgs::msg::PathPoint& p)
{
    p.pose = pose;
}

template<> inline void setPose(const geometry_msgs::msg::Pose& pose, mpc_msgs::msg::TrajectoryPoint& p)
{
    p.pose = pose;
}

template<class T> inline void setOrientation(const geometry_msgs::msg::Quaternion& orientation, T& p)
{
    auto pose        = getPose(p);
...
template<class T> void setLongitudinalVelocity([[maybe_unused]] const double velocity, [[maybe_unused]] T& p)
{
...
template<> inline void setLongitudinalVelocity(const double velocity, mpc_msgs::msg::TrajectoryPoint& p)
{
    p.longitudinal_velocity_mps = velocity;
}

template<> inline void setLongitudinalVelocity(const double velocity, mpc_msgs::msg::PathPoint& p)
{
    p.longitudinal_velocity_mps = velocity;
}
...
inline geometry_msgs::msg::Vector3 getRPY(const geometry_msgs::msg::PoseWithCovarianceStamped& pose)
{
    return getRPY(pose.pose.pose);
}

inline geometry_msgs::msg::Quaternion createQuaternion(const double x, const double y, const double z, const double w)
{
...
inline geometry_msgs::msg::Quaternion createQuaternionFromRPY(const double roll, const double pitch, const double yaw)
{
    tf2::Quaternion q;
...
template<class Point1, class Point2> double calcDistance2d(const Point1& point1, const Point2& point2)
{
...
template<class Point1, class Point2> double calcSquaredDistance2d(const Point1& point1, const Point2& point2)
{
    const auto p1 = getPoint(point1);
    const auto p2 = getPoint(point2);
...
template<class Point1, class Point2> double calcDistance3d(const Point1& point1, const Point2& point2)
{
    const auto p1 = getPoint(point1);
    const auto p2 = getPoint(point2);
 ...
 */
inline double calcElevationAngle(const geometry_msgs::msg::Point& p_from, const geometry_msgs::msg::Point& p_to)
{
 ...
 */
inline double calcAzimuthAngle(const geometry_msgs::msg::Point& p_from, const geometry_msgs::msg::Point& p_to)
{
...
template<class Point1, class Point2> tf2::Vector3 point2tfVector(const Point1& src, const Point2& dst)
{
...
inline Eigen::Vector3d transformPoint(const Eigen::Vector3d& point, const geometry_msgs::msg::Pose& pose)
{
    geometry_msgs::msg::Transform transform;
    transform.translation.x = pose.position.x;
    transform.translation.y = pose.position.y;
...
inline geometry_msgs::msg::Point transformPoint(const geometry_msgs::msg::Point& point, const geometry_msgs::msg::Pose& pose)
{
...
inline geometry_msgs::msg::Point32 transformPoint(const geometry_msgs::msg::Point32& point32,
                                                  const geometry_msgs::msg::Pose&    pose)
{
    const auto point             = geometry_msgs::build<geometry_msgs::msg::Point>().x(point32.x).y(point32.y).z(point32.z);
    const auto transformed_point = mpc_utils::transformPoint(point, pose);
...
template<class T> T transformVector(const T& points, const geometry_msgs::msg::Transform& transform)
{
    T transformed;
...
inline geometry_msgs::msg::Pose transformPose(const geometry_msgs::msg::Pose&             pose,
                                              const geometry_msgs::msg::TransformStamped& transform)
{
...
inline geometry_msgs::msg::Pose transformPose(const geometry_msgs::msg::Pose& pose, geometry_msgs::msg::Transform& transform)
{
...
inline geometry_msgs::msg::Pose transformPose(const geometry_msgs::msg::Pose& pose,
                                              const geometry_msgs::msg::Pose& pose_transform)
{
...
inline geometry_msgs::msg::Pose inverseTransformPose(const geometry_msgs::msg::Pose&             pose,
                                                     const geometry_msgs::msg::TransformStamped& transform)
{
    tf2::Transform tf;
...
// Transform pose in world coordinates to local coordinates
inline geometry_msgs::msg::Pose inverseTransformPose(const geometry_msgs::msg::Pose& pose,
                                                     const geometry_msgs::msg::Pose& transform_pose)
{
    tf2::Transform transform;
...
inline Eigen::Vector3d inverseTransformPoint(const Eigen::Vector3d& point, const geometry_msgs::msg::Pose& pose)
{
...
// Transform point in world coordinates to local coordinates
inline geometry_msgs::msg::Point inverseTransformPoint(const geometry_msgs::msg::Point& point,
                                                       const geometry_msgs::msg::Pose&  pose)
{
    const Eigen::Vector3d     local_vec = inverseTransformPoint(Eigen::Vector3d(point.x, point.y, point.z), pose);
...
inline double calcCurvature(const geometry_msgs::msg::Point& p1,
                            const geometry_msgs::msg::Point& p2,
                            const geometry_msgs::msg::Point& p3)
{
    // Calculation details are described in the following page
    // https://en.wikipedia.org/wiki/Menger_curvature
    const double denominator = calcDistance2d(p1, p2) * calcDistance2d(p2, p3) * calcDistance2d(p3, p1);
...
template<class Pose1, class Pose2> bool isDrivingForward(const Pose1& src_pose, const Pose2& dst_pose)
{
 ...
 * pose.
 */
inline geometry_msgs::msg::Pose calcOffsetPose(const geometry_msgs::msg::Pose& p, const double x, const double y, const double z)
{
    geometry_msgs::msg::Pose      pose;
    geometry_msgs::msg::Transform transform;
...
geometry_msgs::msg::Pose calcInterpolatedPose(const Pose1& src_pose,
                                              const Pose2& dst_pose,
                                              const double ratio,
                                              const bool   set_orientation_from_position_direction = true)
{
    ...
    output_pose.position = calcInterpolatedPoint(getPoint(src_pose), getPoint(dst_pose), clamped_ratio);
...
inline geometry_msgs::msg::Twist createTwist(const geometry_msgs::msg::Vector3& velocity, geometry_msgs::msg::Vector3& angular)
{
 ...
 */
//
inline bool isTwistCovarianceValid(const geometry_msgs::msg::TwistWithCovariance& twist_with_covariance)
{
