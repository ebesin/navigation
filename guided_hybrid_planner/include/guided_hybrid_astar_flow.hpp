...
class GuidedHybridAstarFlow : public nav2_util::LifecycleNode {
 public:
  ...
  void createRSPath(geometry_msgs::msg::PoseStamped begin_pose,
                    geometry_msgs::msg::PoseStamped end_pose,
                    nav_msgs::msg::Path& rs_path);
   ...
   */
  nav_msgs::msg::Path createPlan(const geometry_msgs::msg::Pose& start,
                                 const geometry_msgs::msg::Pose& goal);

 private:
  void mapToWorld(nav2_costmap_2d::Costmap2D* costmap, const double& mx,
                  const double& my, double& wx, double& wy);
